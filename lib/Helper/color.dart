...
const Color primary = Color(0xFFa92bb9);
const Color secondary=Color(0xff3c22fe);
const Color fontColor=Color(0xff111111);
// const Color grad1Color=Color(0xffFFBD69);
const Color grad1Color=Color(0xFFa92bb9);
// const Color grad2Color=Color(0xffFF6363);
const Color grad2Color=Color(0xff3c22fe);
...
const Color lightWhite1 = Color(0xFFa92bb9);
const Color darkColor = Color(0xFFa92bb9);
const Color darkColor2 = Color(0xFFa92bb9);
